...
---
= 通过Digital Advisor提升您的存储系统可持续性评分
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
*** 您也可以随时查看推迟的操作，并选择*Consider*将其移至*Recommended actions*选项卡。+ image:actions_for_later.png["屏幕截图、显示带有\"考虑\"选项的建议操作。"]
...
** 如果选择*later*，则会将选定的建议操作移至*Actionsfor Later*选项卡。选定操作将推迟30天。30天后，此操作将移至*建议操作*选项卡。
** 您也可以随时查看推迟的操作，并选择*Consider*将其移至*Recommended actions*选项卡。
