...
* *AutoSupport 采用*：显示已启用 AutoSupport 的系统的数量和百分比。您还可以查看标记为"拒绝"的系统、启用了 *HTTPS* 和 *AutoSupport on Demand* 的系统，以及在过去 7 天内停止发送 AutoSupport 数据的系统的*信号丢失*情况。要查看您的健康检查分数以及安装库中系统的相关信息，请单击 *AutoSupport 采用*小组件。
