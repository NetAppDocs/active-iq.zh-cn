...
---
= 使用NetApp Docker 镜像运行 Ansible playbook
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
* link:task_update_AFF_FAS_firmware.html["下载AFF和FAS固件的"Ans还是 自动化"软件包"]
* link:task_hosting_firmware_files_using_web_server.html["使用Web服务器托管固件文件"]
