...
---
= 在Digital Advisor中查看操作风险，并使用 Unified Manager 或 Ansible Playbook 进行缓解。
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
| 使用 Unified Manager 降低风险 | 使用 Ansible 攻略手册降低风险 
 ...
 a| 
. 选择 image:spanner.png["扳手"] 图标。
. 选择 *Fix It* 以启动 Active IQ Unified Manager。
. 选择*安装*以安装 Active IQ Unified Manager 9.7 或更高版本，以使用*修复*选项。
. 选择*升级*以升级到 Active IQ Unified Manager 9.7 或更高版本，以使用*修复*选项。

 a| 
. 选择 image:update_ansible.png["更新 Ansible"] 图标。
. 选择*下载*以下载 AFF 和 FAS 固件 Ansible Automation 软件包。
