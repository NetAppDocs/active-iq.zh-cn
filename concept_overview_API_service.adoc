...
任一视图都允许用户使用左侧的导航窗格浏览可用项目。这些项目按服务按字母顺序排列。在给定的服务中，您可以展开标题以显示单个 API 端点。选择服务标题或 API 端点将转到中间窗格中的目录部分。
...
有关如何访问和使用 Digital Advisor API 的信息，请参见 link:https://docs.netapp.com/us-en/digital-advisor-automation/["NetApp Digital Advisor API 文档"]。
