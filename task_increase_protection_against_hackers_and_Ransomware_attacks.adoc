...
---
= 利用Digital Advisor检测安全风险并采取纠正措施
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
.步骤
. 登录到Digital Advisor。
. 在 *Security & Ransomware Defense* 小部件中选择 *Actions*。 image:Security_Image 2 Ransomware attacks.png["安全漏洞小工具"]
. 清除*防防兰索程序*复选框。
. 对于影响较大的安全风险，请按照建议的操作升级操作系统。
. 选择 *Unique Risks* 选项卡，然后选择 *Corrective Action* 列中的链接。 image:Corrective Action_Image 2 Ransomware attacks.png["Corrective Action 列"]
+
