...
Active IQ Digital Advisor正在更改为Digital Advisor ，并且现在已集成到BlueXP（NetApp 用于混合多云环境的统一管理控制台）中。link:https://docs.netapp.com/us-en/active-iq/digital-advisor-integration-with-console.html["了解更多信息。"] 。
