...
* 健康工作流程现在包括可持续性小部件，它提供客户、监视列表、站点和组级别的建议操作的数量。您可以单击操作数量，以在可持续性仪表板上详细查看这些建议的操作。要了解更多信息，请参阅link:https://docs.netapp.com/us-en/active-iq/learn-about-sustainability.html["分析存储系统的可持续性"]。
...
单击 SVM 表中的蓝色"Volume Summary"框后，"弹出窗口"将显示有关托管的卷或已连接到特定序列号或物理节点的卷的详细信息。
