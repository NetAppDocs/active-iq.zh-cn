...
---
= 运行 Ansible playbook 时不使用NetApp Docker 镜像
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
----
+
有关 ansible-galaxy 命令的更多信息，请参阅 link:https://docs.ansible.com/projects/ansible/latest/cli/ansible-galaxy.html["Ansible GALAXY 文档"^]；有关 NetApp Ansible Collection 的更多信息，请参阅 link:https://galaxy.ansible.com/netapp/ontap["NetApp Ansible Collection 页面"^]。
