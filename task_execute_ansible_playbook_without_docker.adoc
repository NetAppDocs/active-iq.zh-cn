...
.步骤
. 安装 link:https://docs.python.org/3/using/windows.html["Python"] 和 。
...
----
+
有关 Ansible galxy 命令的详细信息，请参见 link:https://docs.ansible.com/ansible/latest/cli/ansible-galaxy.html["Ansible GALAXY 文档"] 有关 NetApp Ansible 资料集的详细信息，请参见 。
